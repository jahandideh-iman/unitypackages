...
namespace Arman.AssetProviding
{
    ...
    {
        public static T InstantiateByType<T>(
            this ISyncUnityAssetProvider assetProvider,
            Transform parent
        )
            where T : Object
        {
        ...
        public static T InstantiateById<T>(
            this ISyncUnityAssetProvider assetProvider,
            string id,
            Transform parent
        )
        ...
        public static async Task<T> InstantiateByTypeAsync<T>(
            this IAsyncUnityAssetProvider assetProvider,
            Transform parent
        )
            where T : Object
        {
        ...
        public static async Task<T> InstantiateByIdAsync<T>(
            this IAsyncUnityAssetProvider assetProvider,
            string id,
            Transform parent
        )
