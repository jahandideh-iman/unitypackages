...
<root>
  ...
  ├── Editor
  │   ├── Undefined.InGameMessageLogging.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.InGameMessageLogging.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.InGameMessageLogging.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.InGameMessageLogging.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.InGameMessageLogging`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package In Game Message Logging Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.InGameMessageLogging.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.InGameMessageLogging.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.InGameMessageLogging.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.InGameMessageLogging.Tests.asmdef`
...
Use the `Documentations~/In Game Message Logging.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
