...
namespace Arman.ShopManagement
{
    ...
    public interface IShopCenter
    {
        ...
        void AssignPurchaseHandler<T>(IPurchaseHandler purchaseHandler)
        ...
        ICollection<T> PackagesOfType<T>()
            where T : IShopPackage;

        void SetPurchaseSuccessCallback(
            Action<IShopPackage, IPurchaseSuccessResult> onPurchaseSucceeded
        );
        void SetPurchaseFailureCallback(
