...
<root>
  ...
  ├── Editor
  │   ├── Undefined.ShopManagement.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.ShopManagement.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.ShopManagement.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.ShopManagement.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.ShopManagement`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Shop Management Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.ShopManagement.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.ShopManagement.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.ShopManagement.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.ShopManagement.Tests.asmdef`
...
Use the `Documentations~/Shop Management.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
