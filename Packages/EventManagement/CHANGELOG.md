...
- `BasicEventManager`, renamed to `EventManager`. It was the only implementation of `IEventManager`, so the `Basic` prefix distinguished it from nothing. **Breaking** — update references to the new name.
...
First release of _Event Management_.
