...
<root>
  ...
  ├── Editor
  │   ├── PandasCanPlay.EventManagement.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── PandasCanPlay.EventManagement.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── PandasCanPlay.EventManagement.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── PandasCanPlay.EventManagement.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `PandasCanPlay.EventManagement`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Event Management Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/PandasCanPlay.EventManagement.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/PandasCanPlay.EventManagement.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/PandasCanPlay.EventManagement.Editor.Tests.asmdef`

  `Tests/Runtime/PandasCanPlay.EventManagement.Tests.asmdef`
...
Use the `Documentations~/Event Management.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
