...
**No package carries a pre-release suffix.** Seven packages were `0.1.0-preview`; all were bumped to plain `0.1.0` on 2026-08-30. Most publishable packages are still `0.x`, which is a deliberate, still-open question for Package Manager visibility — see §5 of the GitHub spec.
