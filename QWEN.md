...
This repo is a host for **18 embedded UPM packages** — `Assets/` is only a scratch sandbox. It is hosted on **GitHub** (use `gh`), unlike the sibling PopBalloon repo which is on GitLab.
